 ...
 * {@link MeetingListFragment} and the item details
 * (if present) is a {@link MeetingDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link MeetingListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class MeetingListActivity extends FragmentActivity
        implements MeetingListFragment.Callbacks {
    ...
    /**
     * Callback method from {@link MeetingListFragment.Callbacks}
